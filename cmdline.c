...
const char *gengetopt_args_info_help[] = {
  ...
  "  -c, --compact        The parameter processes files in compact mode",
  "  -d, --dir=STRING     The parameter processes all regular files in the DIR\n                         directory",
  "      --discrete=INT   The parameter shows the count of the values\n                         ​​indicated in the list of values",
  "  -f, --file=STRING    The parameter processes the files indicated in the list",
  "  -h, --no-help        ola",
  "  -m, --mode=INT       The parameter makes an octet, bi-octet or quad-octet\n                         oriented count",
  "  -o, --output=STRING  The parameter implies that the results of the\n                         application must be written to the file file",
  "  -s, --search=INT     The parameter indicates all occurrences of the octet\n                         pattern padraoEmHex",
  "      --time           The parameter indicates in seconds, with precision up to\n                         microseconds, the execution time of the application",
    0
};
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'c':	/* The parameter processes files in compact mode.  */
          ...
          break;
        case 'd':	/* The parameter processes all regular files in the DIR directory.  */
          ...
          break;
        case 'f':	/* The parameter processes the files indicated in the list.  */
        ...
        case 'h':	/* ola.  */
          ...
          break;
        case 'm':	/* The parameter makes an octet, bi-octet or quad-octet oriented count.  */
          ...
          break;
        case 'o':	/* The parameter implies that the results of the application must be written to the file file.  */
          ...
          break;
        case 's':	/* The parameter indicates all occurrences of the octet pattern padraoEmHex.  */
        
        
          if (update_arg( (void *)&(args_info->search_arg), 
               &(args_info->search_orig), &(args_info->search_given),
              &(local_args_info.search_given), optarg, 0, 0, ARG_INT,
              check_ambiguity, override, 0, 0,
              "search", 's',
              additional_error))
            goto failure;
        ...
        case 0:	/* Long option with no short option */
          ...
          /* The parameter shows the count of the values ​​indicated in the list of values.  */
          ...
          /* The parameter indicates in seconds, with precision up to microseconds, the execution time of the application.  */
