...
PROGRAM_OBJS=main.o debug.o memory.o mode_compact.o $(PROGRAM_OPT).o
...
# Dependencies
main.o: main.c debug.h memory.h mode_compact.h $(PROGRAM_OPT).h
$(PROGRAM_OPT).o: $(PROGRAM_OPT).c $(PROGRAM_OPT).h

debug.o: debug.c debug.h
memory.o: memory.c memory.h
mode_compact.o: mode_compact.c mode_compact.h
